...
const NavBar = () => {
    ...
    return (
        // <nav className='bg-red-500 fixed mb-20 flex items-center justify-between w-full'>
        ...
        //   </li>
        //   <li>
        //     <Link to="education" smooth={true} duration={500} offset={-200}>
        //       Education
        //     </Link>
        //   </li><li>
        ...
        //     <div className='bg-purple-500 m-8 flex items-center justyfy-center gap-4 text-2xl'>
    ...
    // </nav>
        ...
        // <nav class="fixed w-full top-0 left-20 bg-red-800 mb-20 flex items-center justify-between py-6">
        //         <div className='bg-blue-500 flex flex-shrink-0 items-center'>
        //             <img className='mx-2 w-10' src={logo} alt='logo'></img>
        //         </div>
