...
export const EXPERIENCES = [
    ...
    description: [ "In my current role, I manage the operation, monitoring, and maintenance of the mission-critical network infrastructures for the Federal Court of Justice, ensuring the continuous availability and stability of essential systems such as switches, routers, and firewalls. My responsibilities extend to directing large-scale network projects, where I provide end-to-end planning and coordination for interdisciplinary teams and external service providers. By architecting secure, encrypted site-to-site connectivity and leading technical procurement procedures, I ensure that the federal communication channels remain both high-performing and resilient.", "Complementing my operational expertise, I serve as the primary Security Point of Contact (SPOC) for the Federal Office for Information Security (BSI). In this capacity, I advance strategic IT security initiatives in strict accordance with BSI IT-Grundschutz standards, while simultaneously managing incident response and mitigating security-relevant threats. My work involves handling high-level inquiries from federal ministries and developing comprehensive security concepts to safeguard sensitive judicial data.", "Furthermore, I play a pivotal role as an IT Architect within the Federal IT Consolidation Project. I am responsible for evaluating and migrating complex IT solutions into the Infrastructure-as-a-Service (IaaS) environments of the Federal Cloud. By designing cross-disciplinary target architectures and providing strategic consulting to senior management and decision-makers, I facilitate seamless communication between federal authorities and external partners, driving the digital modernization of the German federal administration."],
